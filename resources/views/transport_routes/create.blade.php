...
@section('title', 'Add Transport Routes')

@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Add Transport Routes</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Transport Routes</li>
                </ol>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-title">Create Transport Routes</h5>
                    {!! Form::open(array('route' => 'transport-routes.store','method'=>'POST', 'class' => 'form-material m-t-40 create')) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    @foreach($transports as $value)
                                        <div class="col-md-3">
                                            <label>{{ Form::checkbox('vehicles[]', $value->id, false, array('class' => 'name')) }}
