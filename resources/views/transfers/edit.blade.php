                    ...
                    {!! Form::model($data, array('route' => ['transfers.update', $data->id],'method'=>'PATCH', 'class' => 'form-material m-t-40 create', 'enctype' => 'multipart/form-data')) !!}
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" name="admission_id" class="form-control" required placeholder="Student Name" value="{{ $admission->student_name }}" readonly>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                @isset($data->doc)
                                <img src="{{ url('public/uploads/transfers/' . $data->doc) }}" alt="{{ $admission->student_name }}'s docs"
