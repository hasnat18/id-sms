            ...
            <td style="width: 33%;padding-right: 10px; ">
                <div style="border: 1px solid gray; padding: 5px;">
                    <div style="display: flex; justify-content: space-around">
                        <p style="text-align: left">{{ get_setting('fee_bank_name') }}, <br> {{ get_setting('fee_bank_branch') }}</p>
                        <p style="text-align: right">Due Date <br> {{ \Carbon\Carbon::parse( $fee->due_date )->format('d.m.Y')  }} <br> BANK COPY</p>
                    </div>
                    <p style="font-weight: bold">A/c. {{ get_setting('fee_bank_account') }}</p>
                ...
                <div STYLE="text-align: center">
                    <p style="font-weight: bold">{{ get_setting('site_title') }} <br> {{ get_setting('site_address') }}</p>
                </div>
