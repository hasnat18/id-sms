...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Add Study Material</h4>
        </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-title">Create Study Material</h5>
                    {!! Form::open(array('route' => 'study-materials.store','method'=>'POST', 'class' => 'form-material m-t-40 create', 'enctype' => 'multipart/form-data')) !!}
