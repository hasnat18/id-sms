...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Show Study Material</h4> </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                </ol> <a href="{{ route('study-materials.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Back</a> </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="card-body"> {{-- @dd($sm->upload);--}}
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div>
                                @if($sm->upload !== null)
                                    <img src="{{ url('public/uploads/study/'.$sm->upload) }}" alt="" style="height: 150px">
                                @endif </div>
                        </div>
                    </div>
                </div>
