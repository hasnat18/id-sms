...
<html>
    <head>
        ...
        <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif {{ 'School Management System' }}</title>
        <link rel="icon" type="image/png" href="{{ url('public/installer/img/favicon/favicon-16x16.png') }}" sizes="16x16"/>
        <link rel="icon" type="image/png" href="{{ url('public/installer/img/favicon/favicon-32x32.png') }}" sizes="32x32"/>
        <link rel="icon" type="image/png" href="{{ url('public/installer/img/favicon/favicon-96x96.png') }}" sizes="96x96"/>
        <link href="{{ url('public/installer/css/style.min.css') }}" rel="stylesheet"/>
        @yield('style')
        <script>
